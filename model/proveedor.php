...
class proveedor extends fs_model
{
   ...
   /**
    * TRUE -> el proveedor está afecto a retención,
    * @var type
    */
   public $retencion;
   ...
   public function __construct($p=FALSE)
   {
      ...
      if($p)
      {
         ...
         $this->retencion = $this->str2bool($p['retencion']);
      }
      else
      {
      ...
      if( $this->test() )
      {
         ...
         if( $this->exists() )
         {
            $sql = "UPDATE ".$this->table_name." SET nombre = ".$this->var2str($this->nombre).
                    ...
                    ", retencion = ".$this->var2str($this->retencion).
         ...
         else
         {
            $sql = "INSERT INTO ".$this->table_name." (codproveedor,nombre,razonsocial,tipoidfiscal,cifnif,
               ...
               regimeniva,acreedor,personafisica,retencion) VALUES (".$this->var2str($this->codproveedor).
