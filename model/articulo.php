...
class articulo extends fs_model
{
   ...
   /**
    * Boolean si se le aplica retención al artículo.
    * @var boolean
    */
   public $retencion;
   ...
   public function __construct($a=FALSE)
   {
      ...
      if( !isset(self::$column_list) )
      {
         self::$column_list = 'referencia,codfamilia,codfabricante,descripcion,pvp,factualizado,costemedio,'.
                 ...
                 'partnumber,codsubcuentacom,codsubcuentairpfcom,trazabilidad,retencion';
      }
      ...
      if($a)
      {
         ...
         $this->retencion = $this->str2bool($a['retencion']);
         $this->imagen = NULL;
         if( isset($a['imagen']) )
         {
            /**
